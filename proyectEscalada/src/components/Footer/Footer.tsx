...
function Footer() {
    return <div className={` d-flex justify-content-between flex-lg-row flex-column ${FooterStyle.footerDiv}`}>
        <div className="d-flex flex-column pt-4 ">
            <div className="d-flex flex-row pt-2 px-2 pb-2 " >
                ...
                <p className="text-white px-2"> 24 n736 entre 46 y 47 La Plata</p>
            </div>
            <div className="d-flex flex-row pt-2 px-2 pb-2">
                <a className="navbar-brand d-flex flex-row" href="https://www.instagram.com/proyect.escalada/">
                    ...
                    <p className="text-white px-2">proyect.escalada</p>
                </a>
            </div>
        </div>
        <div>
            <img src="images/logo.jpg" alt="logoNavBar" width="200" height="200"></img>
        </div>
        <div className="d-flex  flex-column pt-4 px-4">
            <p className="text-white">Lunes a Jueves de 16hs a 22hs</p>
            <p className="text-white"> Viernes de 14hs a 22hs</p>
            <p className="text-white">  Sábados, domingos y feriados de 15hs a 21hs</p>
        </div>
    </div>
}
